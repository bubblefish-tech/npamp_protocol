...
- **Layer 1 — Architecture Decision Records (the durable "why").** Every
  ...
  `decisions/`, in **MADR 4.0** format (see `decisions/template.md`):
...
underlying standards (RFC 5869, RFC 9846, RFC 9180, FIPS 203, Project
...
e.g. `n-pamp/4`). Additive registrations (for example a new suite identifier)
