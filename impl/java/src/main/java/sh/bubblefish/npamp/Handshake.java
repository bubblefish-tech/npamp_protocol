...
public final class Handshake {
    ...
    public static final String CONTEXT_SERVER_CERTVERIFY = "N-PAMP/3, server CertificateVerify";
    public static final String CONTEXT_CLIENT_CERTVERIFY = "N-PAMP/3, client CertificateVerify";
