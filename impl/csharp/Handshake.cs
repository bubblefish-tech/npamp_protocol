...
public static class Handshake
{
    ...
    public const string ContextServerCertVerify = "N-PAMP/3, server CertificateVerify";
    public const string ContextClientCertVerify = "N-PAMP/3, client CertificateVerify";
