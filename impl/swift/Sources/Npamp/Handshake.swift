...
public enum Handshake {
    ...
    public static let contextServerCertVerify = "N-PAMP/3, server CertificateVerify"
    public static let contextClientCertVerify = "N-PAMP/3, client CertificateVerify"
